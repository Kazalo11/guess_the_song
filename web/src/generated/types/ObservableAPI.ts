...
export class ObservableDefaultApi {
     ...
     */
    public v1SpotifyArtistArtistIdRandomSongsGetWithHttpInfo(artistId: string, _options?: ConfigurationOptions): Observable<HttpInfo<ArtistSongResponse>> {
    ...
    _config = {
      ...
      middleware: allMiddleware || this.configuration.middleware
        ...
        const requestContextPromise = this.requestFactory.v1SpotifyArtistArtistIdRandomSongsGet(artistId, _config);
        // build promise chain
        ...
        return middlewarePreObservable.pipe(mergeMap((ctx: RequestContext) => this.configuration.httpApi.send(ctx))).
            pipe(mergeMap((response: ResponseContext) => {
                ...
                return middlewarePostObservable.pipe(map((rsp: ResponseContext) => this.responseProcessor.v1SpotifyArtistArtistIdRandomSongsGetWithHttpInfo(rsp)));
            }));
    }
     ...
     * @param artistId ArtistID
     */
    public v1SpotifyArtistArtistIdRandomSongsGet(artistId: string, _options?: ConfigurationOptions): Observable<ArtistSongResponse> {
        return this.v1SpotifyArtistArtistIdRandomSongsGetWithHttpInfo(artistId, _options).pipe(map((apiResponse: HttpInfo<ArtistSongResponse>) => apiResponse.data));
    }
